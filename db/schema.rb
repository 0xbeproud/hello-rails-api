...
ActiveRecord::Schema.define(version: 2020_09_15_055717) do
  ...
  create_table "identities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
